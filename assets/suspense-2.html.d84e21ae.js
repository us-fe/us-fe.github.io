...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="source" tabindex="-1"><a class="header-anchor" href="#source" aria-hidden="true">#</a> Source</h2>`,8),k={href:"https://bigfrontend.dev/react-quiz/Suspense-2",target:"_blank",rel:"noopener noreferrer"},d=l("Source From");function v(m,b){const s=t("ExternalLinkIcon");return i(),e(o,null,[r,n("p",null,[n("a",k,[d,p(s)])])],64)}var f=a(u,[["render",v],["__file","suspense-2.html.vue"]]);export{f as default};
